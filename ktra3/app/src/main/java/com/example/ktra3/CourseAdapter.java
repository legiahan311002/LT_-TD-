...
public class CourseAdapter extends BaseAdapter {
    ...
    private int layout;
    private List<com.example.ktra3.Course> courseList;

    public CourseAdapter(Context context, int layout, List<com.example.ktra3.Course> courses) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Gán giá trị
        com.example.ktra3.Course course = courseList.get(position);
