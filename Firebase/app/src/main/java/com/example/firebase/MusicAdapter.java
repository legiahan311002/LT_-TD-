...
public class MusicAdapter extends FirebaseRecyclerAdapter<com.example.firebase.Music, MusicAdapter.myViewHolder> {
     ...
     * @param options
     */
    public MusicAdapter(@NonNull FirebaseRecyclerOptions<com.example.firebase.Music> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull com.example.firebase.Music model) {
